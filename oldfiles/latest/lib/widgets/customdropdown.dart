...
//  final dynamic DMchild;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
      Text(labelText ?? hintText, style: TextStyle(fontSize: 14, fontFamily: 'Sansation', fontWeight: FontWeight.bold),),
    SizedBox(height: 10,),
        Container(
          // height: MediaQuery.of(context).size.height*0.095,
        padding: EdgeInsets.all(10),
        decoration: BoxDecoration(
          color: bgColor ?? Colors.pink.withOpacity(0.09),
        ...
        child: DropdownButtonHideUnderline(
            ...
            items: items.map<DropdownMenuItem>((dynamic value) {
              return DropdownMenuItem(
                value: value,
                child: Text(value.toString(), style: TextStyle(fontWeight: FontWeight.normal, fontSize: 14, fontFamily: 'Sansation', fontStyle: FontStyle.normal),),
              );
            }).toList(),
          ),
        ),
