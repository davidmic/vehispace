...
class MoreDetailsVehicle extends StatelessWidget {
  MoreDetailsVehicle({this.manufacturer, this.vehicleType, this.engineType, this.imageURL, this.closeCallback, this.content});
...
//                                imageUrl != null ? Image.network(imageUrl) :
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text('Vehicle Specific Tip:', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12, fontFamily: 'Sensation'), ),
                    ],
                  ),
                ),
                Padding(
