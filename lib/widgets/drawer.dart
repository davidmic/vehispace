...
//           ),
           buildDrawerNav(
            ...
            text: 'Notification',
            show: MyHomePageState().newNotification == 0 ? false : true,
            onpressed: () {
                setState(() {
                   MyHomePageState().newNotification = 0;
               });
...
//               Navigator.pushNamed(context, '/notification');
//             },
//             trailing: MyHomePageState().newNotification == 0 ? null : Badge(
//               badgeColor: Color(0xffff0000),
//               showBadge: true,
//               shape: BadgeShape.circle,
//             ),
...
//          ),
 ...
 //            trailing: Text('.', style: TextStyle(color: Color(0xffff0000), fontWeight: FontWeight.bold, fontSize: 15),),
  ...
  InkWell buildDrawerNav({Function onpressed, IconData icon, String text, bool show = false, double iconSize, Color iconColor, FontWeight fontWeight, double fontSize}) {
    bool showBadge = show;
    return InkWell(
          onTap: onpressed,
          child: Padding(
              ...
              children: <Widget>[
                Row(
                  children: [
                    ...
                    SizedBox(width: 30),
                    Text(text, style: Constants.drawerliststyle,),
                  ]
                ),
                showBadge ?
              Badge(
