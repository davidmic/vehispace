...
class MyVehicleRegistration extends StatefulWidget {
  @override
  _MyVehicleRegistrationState createState() => _MyVehicleRegistrationState();
}

class _MyVehicleRegistrationState extends State<MyVehicleRegistration> {
  String vehicle;
