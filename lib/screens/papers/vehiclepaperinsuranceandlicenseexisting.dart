...
class VehiclePapersInsuranceAndLicenseExisting extends StatefulWidget {
  final Function onPressed;
  final Function onBack;
  int index;
  VehiclePapersInsuranceAndLicenseExisting({this.onPressed, this.index, this.onBack});
  @override
  _VehiclePapersInsuranceAndLicenseExistingState createState() => _VehiclePapersInsuranceAndLicenseExistingState();
}

class _VehiclePapersInsuranceAndLicenseExistingState extends State<VehiclePapersInsuranceAndLicenseExisting> {
...
//                        if (transDate.day == null) {
//                          Fluttertoast.showToast(
//                            msg: 'Transaction field is empty',
//                            textColor: Colors.black,
//                            gravity: ToastGravity.CENTER,
//                            toastLength: Toast.LENGTH_SHORT,
//                            backgroundColor: Color(0xffe5e5e5),
