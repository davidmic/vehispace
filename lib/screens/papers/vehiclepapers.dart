...
class VehiclePapers extends StatefulWidget {
  final Function onPressed;
  final Function onBack;
  VehiclePapers({this.onPressed, this.onBack});
  @override
  _VehiclePapersState createState() => _VehiclePapersState();
}

class _VehiclePapersState extends State<VehiclePapers> {
...
//                ),
                ...
                CustomDropdown(
                    value: vehicleMake ?? vehiclePaperBloc.vehiclePaperModel.vehicleMake,
                    onChanged: (val){
                      MyVehicleBloc().x(val);
                      setState(() {
                        vehicleMake = val;
                ...
                CustomTextField(
                  intialValue: vehiclePaperBloc.vehiclePaperModel.year,
                  inputFormatters: [
