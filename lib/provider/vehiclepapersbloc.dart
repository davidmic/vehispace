...
class VehiclePaperBloc extends ChangeNotifier {
  ...
  setVehiclePaperDetails ({VehiclePapersModel vehiclePaperData}) {
      vehiclePaperModel = VehiclePapersModel(
        ...
        model: vehiclePaperData.model,
        year: vehiclePaperData.year,
  ...
  storeVehicleRenewalRequest ({VehiclePapersModel vehiclePaperData, paymentStatus, paymentResponse, paymentReference, cost}) async {
    FirebaseUser user = await _auth.currentUser();
    try {
      final storeVehicleRenewalRequest = await _store.collection('vehiclerenewalrequest').document(user.uid).collection('request').document(vehiclePaperData.vehicleId).setData(
          {
            'userid' : user.uid,
            'country' : vehiclePaperData.country,
            'state': vehiclePaperData.state,
            ...
            'requestTime' : vehiclePaperData.requestTime,
            'requestDate' : vehiclePaperData.requestDate,
            'vehicleId' : vehiclePaperData.vehicleId,
